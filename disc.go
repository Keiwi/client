...
// PartitionResponse contains information about a specific partition
...
// DiscResponse contains information about multiple PartitionResponses
type DiscResponse struct {
	Error      string              `json:"error"`
	Partitions []PartitionResponse `json:"partitions"`
}

// DiscCheck gathers information about partitions on the current system
